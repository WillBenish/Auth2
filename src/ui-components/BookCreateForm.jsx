...
export default function BookCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setCover_s3_key(initialValues.cover_s3_key);
    setCreatorUserId(initialValues.creatorUserId);
    setBookPages(initialValues.bookPages);
    setCurrentBookPagesValue("");
    setIntro_video_s3_key(initialValues.intro_video_s3_key);
    setOutro_video_s3_key(initialValues.outro_video_s3_key);
    setRaw_book_read_s3_key(initialValues.raw_book_read_s3_key);
    setErrors({});
  };
